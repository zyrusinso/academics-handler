...
<div class="content">
    <div class="block block-rounded overflow-hidden">
        <ul class="nav nav-tabs nav-tabs-block" role="tablist">
            <li class="nav-item">
                <a href="/dashboard/services" class="nav-link active" id="search-projects-tab"><i class="fa fa-step-backward"></i></a>
            </li>
            <li class="nav-item">
        ...
        <div class="row">
                ...
                <div class="col-lg-8 col-xl-5">
                    ...
                    <form class="mb-5" action="{{ route('services.store') }}" method="POST">
                        @csrf
                        <div class="form-group">
                            <label for="example-static-input-readonly">Service Category</label>
                            <input type="text" readonly class="form-control" id="example-static-input-readonly" name="service_category" value="Essay Services">
                        </div>
