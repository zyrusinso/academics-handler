...
<div class="content">
    <div class="block block-rounded overflow-hidden">
        ...
        <a href="{{ route('dashboard.services') }}">
            ...
            <a href="{{ route('dashboard.dissertation') }}">
                <li class="nav-item">
                    <button type="button" class="nav-link" id="search-users-tab" data-bs-toggle="tab"
                        ...
                        aria-selected="false">Dissertation Services</button>
                </li>
            </a>
            <li class="nav-item">
                <button type="button" class="nav-link active" id="search-classic-tab" data-bs-toggle="tab"
                    data-bs-target="#search-classic" role="tab" aria-controls="search-classic"
                    aria-selected="true">Other Services</button>
            </li>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="btn-group">
                                <a href="/dashboard/other/{{ $service->id }}">
                                ...
                                <form action="/dashboard/other/{{ $service->id }}" method="post" id="delete-service">
                                @csrf
                                @method('DELETE')
                        ...
                        <tr>
                            <td>
                                <h4><a href="{{ route('other.create') }}"><i class="fa fa-plus">Add more services</i></a></h4>
                            </td>
                        </tr>
                    </tbody>
                </table>
