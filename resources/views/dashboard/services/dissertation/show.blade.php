...
@section('content')
     ...
     <!-- Hero -->
      ...
      <div class="block block-rounded mb-0">
        ...
        <a href="/dashboard/dissertation" class="nav-link active mr-3" id="search-projects-tab"><i class="fa fa-step-backward"></i></a>
        ...
        <div class="block-content block-content-full">
            <div class="row">
                ...
                <div class="col-lg-8 col-xl-5">
                    ...
                    <form class="mb-5" action="/dashboard/dissertation/{{ $services->id }}" method="POST">
                        @csrf
                        @method('PATCH')
