...
<div class="content">
    <div class="block block-rounded overflow-hidden">
        <ul class="nav nav-tabs nav-tabs-block" role="tablist">
            <li class="nav-item">
                <a href="/dashboard/home" class="nav-link active" id="search-projects-tab"><i
        ...
        <div class="block block-rounded mb-0">
            <div class="block-header mt-4 content">
                <h3 class="block-title">Create Home content</h3>
            </div>
            <div class="block-content block-content-full">
                <div class="row">
                    ...
                    <div class="col-lg-8 col-xl-5">
                        ...
                        <form class="mb-5" action="{{ route('home.store') }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('description') is-invalid @enderror"
                                    id="example-text-input" name="description" placeholder="Description" value="{{ old('description') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('url') is-invalid @enderror"
                                    id="example-text-input" name="url" placeholder="https://example.com" value="{{ old('url') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('url') is-invalid @enderror"
                                    id="example-text-input" name="video_link" placeholder="https://youtube.com/embed/example" value="{{ old('title') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('contact_num') is-invalid @enderror"
                                    id="example-text-input" name="contact_num" placeholder="ex: +123 123456789" value="{{ old('contact_num') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('contact_email') is-invalid @enderror"
                                    id="example-text-input" name="contact_email" placeholder="example@gmail.com" value="{{ old('contact_email') }}">
