...
<div class="content">
    <div class="block block-rounded overflow-hidden">
        <ul class="nav nav-tabs nav-tabs-block" role="tablist">
            <li class="nav-item">
                <a href="{{ route('event.index') }}" class="nav-link active" id="search-projects-tab"><i
        ...
        <div class="block-content tab-content overflow-hidden">
            <div class="row">
                ...
                <div class="col-lg-8 col-xl-5">
                    ...
                    <form class="mb-5" action="{{ route('event.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
