        ...
        <div class="block-content tab-content overflow-hidden">
            <div class="row">
                ...
                <div class="col-lg-8 col-xl-5">
                    ...
                    <form class="mb-5" action="{{ route('post.store') }}" method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <textarea rows="10" cols="10" type="text" class="form-control @error('detail') is-invalid @enderror"
                                id="example-text-input" name="detail" placeholder="Detail"></textarea>
                            @error('detail')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('tags') is-invalid @enderror"
                                id="example-text-input" name="tags" placeholder="Tags" value="{{ old('tags') }}">
