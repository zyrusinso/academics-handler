                ...
                <table class="table table-striped table-vcenter">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                            <img src="{{ asset('storage').'/'.$category->cat_image }}" width="100" />
                            </td>
                            <td class="text-center">
                                ...
                                <form action="{{ route('category.destroy', $category->id) }}" method="post" id="delete-service">
                                @csrf
                                @method('DELETE')
                        ...
                        <tr>
                            <td>
                                <h4><a href="{{ route('category.create') }}"><i class="fa fa-plus">Add more Category</i></a></h3>
                            </td>
                        </tr>
                    </tbody>
                </table>
