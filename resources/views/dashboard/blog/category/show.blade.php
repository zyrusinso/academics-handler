                        ...
                        <form class="mb-5" action="{{ route('category.update', $category->id) }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('title') is-invalid @enderror"
                                    id="example-text-input" name="title" placeholder="Title" value="{{ (old('title'))? old('title') : $category->cat_title }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('detail') is-invalid @enderror"
                                    id="example-text-input" name="detail" placeholder="Detail"
                                    value="{{ (old('detail'))? old('detail') : $category->cat_detail }}">
